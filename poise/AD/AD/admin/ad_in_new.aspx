<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main.Master" ValidateRequest="false"  AutoEventWireup="true" CodeBehind="ad_in_new.aspx.cs" Inherits="AD.admin.ad_in_new" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA"
        ...
        <tr>
            <td colspan="4">
               <span style=" font-size:20px;">信息添加</span>
            </td>
        </tr>
        <tr>
