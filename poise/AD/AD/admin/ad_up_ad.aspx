<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main.Master" AutoEventWireup="true" CodeBehind="ad_up_ad.aspx.cs" Inherits="AD.admin.ad_up_ad" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA"
        ...
        <tr>
            <td style="text-align: center; width: 100px;">
                广告标题:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txttitle"
