<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main.Master" AutoEventWireup="true" CodeBehind="ad_in_team.aspx.cs" Inherits="AD.admin.ad_in_team" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA"
        ...
        <tr>
            <td colspan="4">
               <span style=" font-size:20px;">团队信息添加</span>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtname" Width="450px" runat="server"></asp:TextBox>
            </td>
            <tr>
