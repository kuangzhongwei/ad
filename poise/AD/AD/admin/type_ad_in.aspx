<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main.Master" AutoEventWireup="true" CodeBehind="type_ad_in.aspx.cs" Inherits="AD.admin.type_ad_in" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA"
        style="margin-top: 8px">
        <tr>
            <td colspan="4">
               <span style=" font-size:20px;">服务类型添加</span>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; width: 100px;">
                服务类型名称:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txttitle"
