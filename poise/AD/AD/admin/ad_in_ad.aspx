<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main.Master" AutoEventWireup="true" CodeBehind="ad_in_ad.aspx.cs" Inherits="AD.admin.ad_in_ad" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA"
        ...
        <tr>
            <td colspan="4">
               <span style=" font-size:20px;">广告添加</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                是
                <asp:RadioButton ID="Radiofalse" Checked="true" GroupName="a" runat="server"  />
                否
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RadioButton ID="Radio1" GroupName="b" runat="server" />
                首页
                <asp:RadioButton ID="Radio2"  GroupName="b" runat="server" />
                内容页
            </td>
        </tr>
        <tr>
